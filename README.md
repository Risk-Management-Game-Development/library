...
Instructiuons:
 ...
 You should see a section that allows yu to add a base colour, normal, orm, and maybe a mask.
 Add the corrseponding texture images to the little box.
 Once done, drag the materia onto the 3d model in the viewer.
